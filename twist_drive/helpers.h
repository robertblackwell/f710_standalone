#ifndef H_twist_control_helpers_h
#define H_twist_control_helpers_h
#include <tuple>
 ...
 */
    ...
    /**
     * converts f710 right stick position to a robot velocity in terms of revs-per-minute.
     *
     * Frm rpm it is easy to express the speed in meters per second
     */
    double right_stick_to_linear_vel(int f710_right);

    /**
     * converts f710 left stick position to a robots angular velocity in terms of radians-per-second.
     *
     */
